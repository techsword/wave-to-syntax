...
Derived from john-hewitt/structural-probes
(https://github.com/john-hewitt/structural-probes).
Copyright 2019 John Hewitt. Licensed under the Apache License, Version 2.0.

Modification: adapted imports and flat-schema probe wiring for the
spoken-language structural-probe experiments in this repository.
"""
